...
class ActorsRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/`,authMiddleware, validateSchemaMiddleware(Actor), this.actorController.createActor);
    this.router.put(`${this.path}/:id`,authMiddleware, validateSchemaMiddleware(Actor), this.actorController.updateActor)
  }
}
